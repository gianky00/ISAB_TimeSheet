...
from src.application.services.exceptions import AutomationError
...
from src.infrastructure.bots.portale_fornitori.timbrature.locators import TimbratureLocators
