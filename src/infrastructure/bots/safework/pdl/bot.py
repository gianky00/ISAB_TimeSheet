...
from src.infrastructure.bots.base.base_bot import StepStatus
from src.infrastructure.bots.base.selenium_bot_config import SeleniumBotConfig
from src.infrastructure.bots.base.wait_helpers import poll_for_new_file
from src.infrastructure.bots.safework.base import SafeworkBaseBot
...
from src.infrastructure.utils.printing import print_pdf
...
class SafeWorkPDLBot(SafeworkBaseBot):
    ...
    def _scarica_parte_prima(self, pdl_num: str) -> str | None:
        ...
        try:
            ...
            from src.infrastructure.bots.base.wait_helpers import PollConfig
