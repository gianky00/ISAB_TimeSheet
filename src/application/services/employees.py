...
from src.application.services.database.repositories import EmployeeRepository
...
class EmployeeManager:
    ...
    def import_from_csv(self, csv_path: str) -> int:
        ...
        """
        from src.application.services.processing.base import Pipeline  # noqa: PLC0415
        from src.application.services.processing.employees.import_steps import (  # noqa: PLC0415
            EmployeeCsvReadStep,
