...
from src.application.services.processing.contabilita.import_steps import DatabaseSyncStep, ExcelReadStep
...
class ContabilitaImporterService:
    ...
    def import_certificati_campione(
        ...
        from src.application.services.importers.certificati import CertificatiImporter  # noqa: PLC0415
