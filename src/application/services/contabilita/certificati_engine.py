...
from src.application.services.constants import Icons, StatoCertificatoLabel, UbicazioneStrumenti
...
class CertificatiEngine:
    ...
    @classmethod
    def calculate_days_and_status_with_guasto(
            ...
            processed_groups.append(
                {
                    ...
                    "guasto_tipo": guasto_tipo,
                    "guasto_data": guasto_data,
                    "guasto_note": guasto_note,
                }
            )
