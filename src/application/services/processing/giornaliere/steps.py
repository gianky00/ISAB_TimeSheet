...
from src.application.services.schemas import validate_giornaliere
...
class SyncGiornaliereStep(ProcessingStep):
    ...
    def execute(self, context: dict[str, Any]) -> None:
        ...
        from src.application.services.data_synchronizer import DataSynchronizer  # noqa: PLC0415
        from src.application.services.database import db_manager  # noqa: PLC0415
