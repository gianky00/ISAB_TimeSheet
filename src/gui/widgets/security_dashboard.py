...
from PyQt6.QtWidgets import (
    ...
    QScrollArea, QPushButton, QProgressBar, QMessageBox
)
...
class SecurityDashboard(QWidget):
    ...
    def _update_chart(self, stats):
        ...
        for date_str, data in stats.items():
            ...
            color = "#198754" # green
            if err > 0: color = "#dc3545" # red if any error
            elif warn > 0: color = "#ffc107" # yellow
    ...
    def _run_integrity_check(self):
        ...
        if valid:
            QMessageBox.information(self, "Integrità", "✅ Il registro di Audit è integro e non compromesso.")
        else:
            QMessageBox.warning(self, "Integrità", "⚠️ Rilevata possibile manomissione nel registro di Audit!")
