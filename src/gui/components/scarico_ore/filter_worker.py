...
class FilterWorker(QThread):
    ...
    def __init__(self, search_index: list[str], display_data: list[list[str]],
                 text: str, col_filters: dict[int, set[str]] | None = None, parent=None):
    ...
    def run(self):
        ...
        if search_terms:
            ...
            if self._is_cancelled: return # type: ignore[unreachable]
