...
class TelegramUI:
    ...
    def get_bots_menu() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("    SafeWork", callback_data="nav_safework")],
    ...
    def get_utility_menu() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            ...
            [
                InlineKeyboardButton("    Impostazioni", callback_data="menu_settings"),
    ...
    def get_pdl_menu(merge_all: bool) -> InlineKeyboardMarkup:
        ...
        keyboard = [
            ...
            [
                ...
                InlineKeyboardButton("    Svuota", callback_data="clear_pdl"),
            ],
            [
            ...
            [InlineKeyboardButton("    Avvia (Print ON)", callback_data="run_pdl_on")],
    ...
    def get_ts_menu() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            ...
            [
                ...
                InlineKeyboardButton("    Svuota", callback_data="clear_ts"),
            ],
    ...
    def get_printer_selection_menu(printers: list[str], back_callback: str) -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [InlineKeyboardButton(f"    {p[:30]}", callback_data=f"sel_print_run_{p[:25]}")]
    ...
    def get_settings_menu(fornitori: list[str]) -> InlineKeyboardMarkup:
        ...
        keyboard.extend(
            [
                ...
                [InlineKeyboardButton("    Stampante", callback_data="menu_printers")],
                [TelegramUI.get_back_button("nav_utility")],
            ]
        )
        return InlineKeyboardMarkup(keyboard)
    ...
    def get_printers_menu(printers: list[str]) -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [InlineKeyboardButton(f"    {p[:30]}", callback_data=f"set_print_{p[:30]}")]
            for p in printers[: TelegramUI.MAX_PRINTERS]
        ]
