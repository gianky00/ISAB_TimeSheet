...
class SearchService:
    ...
    def _search_oda(query: str, limit: int) -> list[dict[str, Any]]:
        try:
            ...
            logger.exception("SearchService ODA error", exc=e)
            return []
    ...
    def _search_extended(query: str, limit: int) -> dict[str, list[dict[str, Any]]]:
        try:
            ...
            logger.exception("SearchService Extended error", exc=e)
            return {}
    ...
    def _search_employees(query: str, limit: int) -> list[dict[str, Any]]:
        try:
            ...
            logger.exception("SearchService Employees error", exc=e)
            return []
    ...
    def _search_storico_oda(query: str, limit: int) -> list[dict[str, Any]]:
        ...
        try:
          ...
          """,
            ...
            logger.exception("SearchService Storico ODA error", exc=e)
            return []
    ...
    def _search_attivita_programmate(query: str, limit: int) -> list[dict[str, Any]]:
        ...
        try:
          ...
          """,
            ...
            logger.exception("SearchService AttivitàProgrammate error", exc=e)
            return []
    ...
    def _search_pdl(query: str, limit: int) -> list[dict[str, Any]]:
        ...
        try:
          ...
          """,
            ...
            logger.exception("SearchService PDL error", exc=e)
            return []
    ...
    def _search_audit(query: str, limit: int) -> list[dict[str, Any]]:
        try:
            ...
            logger.exception("SearchService Audit error", exc=e)
            return []
