...
class AnagraficaController:
    ...
    def process_rows(
        ...
        for r in full_rows:
            is_monitored = (
                bool(r[AnagraficaController.MONITORING_COLUMN_INDEX])
                if len(r) > AnagraficaController.MONITORING_COLUMN_INDEX
                and r[AnagraficaController.MONITORING_COLUMN_INDEX] is not None
                else True
            )
