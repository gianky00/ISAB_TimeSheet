...
---
### `tests/unit/test_app_initializer_robust.py::TestAppInitializerRobust::test_initialize_core_failure`
**Error:** `FAILED tests/unit/test_app_initializer_robust.py::TestAppInitializerRobust::test_initialize_core_failure`

**Timestamp:** `2026-02-20T12:45:04.640499`
...
tests\unit\test_app_initializer_robust.py F                              [100%]

================================== FAILURES ===================================
____________ TestAppInitializerRobust.test_initialize_core_failure ____________
tests\unit\test_app_initializer_robust.py:77: in test_initialize_core_failure
    assert result is False
E   assert True is False
=============================== tests coverage ================================
______________ coverage: platform win32, python 3.12.10-final-0 _______________
...
src\utils\validators.py                                                 73     51    30%   56-74, 87-98, 111-126, 139-160, 173-189, 202-205
--------------------------------------------------------------------------------------------------
TOTAL                                                                21667  17296    20%
Coverage HTML written to dir htmlcov
=========================== short test summary info ===========================
FAILED tests/unit/test_app_initializer_robust.py::TestAppInitializerRobust::test_initialize_core_failure
============================== 1 failed in 9.35s ==============================
...
---
### `tests/unit/test_app_startup_sequence.py::TestAppInitializer::test_init_generator_steps`
**Error:** `FAILED tests/unit/test_app_startup_sequence.py::TestAppInitializer::test_init_generator_steps`

**Timestamp:** `2026-02-20T12:47:12.080974`
...
tests\unit\test_app_startup_sequence.py F                                [100%]

================================== FAILURES ===================================
________________ TestAppInitializer.test_init_generator_steps _________________
tests\unit\test_app_startup_sequence.py:41: in test_init_generator_steps
    steps = list(gen)
            ^^^^^^^^^
src\core\app_initializer.py:116: in init_generator
    from src.gui.main_window.page_index import PageIndex
src\gui\main_window\__init__.py:1: in <module>
    from .main import MainWindow
src\gui\main_window\main.py:41: in <module>
    from .components.tool_bar import ToolBarComponent
src\gui\main_window\components\tool_bar.py:12: in <module>
    from src.gui.widgets.sidebar_widget import SidebarWidget
src\gui\widgets\sidebar_widget.py:132: in <module>
    class SidebarWidget(QFrame):
src\gui\widgets\sidebar_widget.py:166: in SidebarWidget
...
src\gui\widgets\security_dashboard.py                                  154    154     0%   1-252
src\gui\widgets\sidebar_button.py                                       41     32    22%   11-24, 28-30, 34-41, 46-51, 55-89
src\gui\widgets\sidebar_widget.py                                      236    210    11%   22-28, 46-49, 53-69, 71-74, 77-79, 83-87, 91, 95-96, 100-103, 107-117, 121-129, 142-164, 168-410
src\gui\widgets\simple_chart.py                                         66     66     0%   1-113
src\gui\widgets\sortable_table_item.py                                  47     37    21%   21-26, 30-58, 63-76, 80-93
src\gui\widgets\statistics_widget.py                                   106    106     0%   1-195
src\gui\widgets\status_card.py                                          60     47    22%   20-85, 89-92, 101-117, 121, 125-126
...
src\utils\validators.py                                                 73     51    30%   56-74, 87-98, 111-126, 139-160, 173-189, 202-205
--------------------------------------------------------------------------------------------------
TOTAL                                                                21868  17482    20%
Coverage HTML written to dir htmlcov
=========================== short test summary info ===========================
FAILED tests/unit/test_app_startup_sequence.py::TestAppInitializer::test_init_generator_steps
============================= 1 failed in 15.55s ==============================
...
---
### `tests/unit/test_app_startup_sequence.py::TestAppInitializer::test_initialize_core_failure_handling`
**Error:** `FAILED tests/unit/test_app_startup_sequence.py::TestAppInitializer::test_initialize_core_failure_handling`

**Timestamp:** `2026-02-20T12:51:33.767604`
...
================================== FAILURES ===================================
__________ TestAppInitializer.test_initialize_core_failure_handling ___________
tests\unit\test_app_startup_sequence.py:61: in test_initialize_core_failure_handling
    assert success is False
E   assert True is False
---------------------------- Captured stdout call -----------------------------
[2026-02-20 12:51:24] INFO     - AppInitializer                 - [INIT CORE] Inizializzazione Nucleo Sistema
[2026-02-20 12:51:24] ERROR    - AppInitializer                 - Failed to setup logging: Log Fail
[2026-02-20 12:51:24] INFO     - AppInitializer                 - [INIT CORE] Caricamento Motori Analisi Dati
[2026-02-20 12:51:25] INFO     - AppInitializer                 - Pandas/Numpy loaded successfully
[2026-02-20 12:51:25] INFO     - AppInitializer                 - [INIT CORE] Configurazione Driver Automazione
[2026-02-20 12:51:25] INFO     - AppInitializer                 - Selenium loaded successfully
[2026-02-20 12:51:25] INFO     - AppInitializer                 - [INIT CORE] Verifica Integrità Hardware
[2026-02-20 12:51:26] INFO     - AppInitializer                 - [INIT CORE] Connessione Database Sistema
[2026-02-20 12:51:26] INFO     - AppInitializer                 - Database initialized successfully
=============================== tests coverage ================================
______________ coverage: platform win32, python 3.12.10-final-0 _______________
