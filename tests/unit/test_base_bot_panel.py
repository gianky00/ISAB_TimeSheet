...
class TestBaseBotPanel:
    ...
    def setup_method(self, qapp):
        ...
        with (
            ...
            patch("src.gui.panels.bot_components.ActivityTimelineWidget"),
            patch("src.gui.panels.bot_components.ModernButton") as mock_btn_class,
            patch("src.gui.panels.bot_components.get_asset_path", return_value="mock.svg"),
