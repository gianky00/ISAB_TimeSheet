...
class TestDataSynchronizerRobust:
    ...
    def test_db(self, tmp_path):
        ...
        with db_manager.get_connection(db_path) as conn:
            ...
            try:
                ...
                conn.execute("CREATE TABLE IF NOT EXISTS storico_oda (numero_oda TEXT PRIMARY KEY, stato TEXT)")
    ...
    def test_sync_contabilita_dati(self, test_db):
        ...
        with db_manager.get_connection(test_db) as conn:
            ...
            conn.execute(f"INSERT INTO contabilita ({safe_cols_str}) VALUES ({placeholders})", row)
            conn.commit()
    ...
    def test_sync_giornaliere(self, test_db):
        ...
        new_rows = [
            ("2024", "01.01.2024", "Rossi", "Desc", "TCL1", "ODC1", "123456/S", "08:00", "17:00", "8", "1", "file.xlsx")
        ]
    ...
    def test_sync_scarico_ore_massive(self, test_db):
        ...
        rows_old = [("2024-01-01", "P1", "P2", "ODC1", "10", "08:00", "17:00", "8.0", "D", "S", "C", "S") for i in range(5)]
        with db_manager.get_connection(test_db) as conn:
            conn.executemany("INSERT INTO scarico_ore (data, pers1, pers2, odc, pos, dalle, alle, totale_ore, descrizione, finito, commessa, styles) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)", rows_old)
            conn.commit()
    ...
    def test_sync_upsert_smart_no_change(self, test_db):
        ...
        added, updated = DataSynchronizer._sync_upsert_smart(test_db, "attivita_programmate", cols, data)
        assert added == 2
