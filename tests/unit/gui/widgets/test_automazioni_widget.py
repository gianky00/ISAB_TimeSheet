...
class TestAutomazioniWidget:
    ...
    def mock_panels(self, mocker):
        ...
        mock_pdl_search = QWidget()
        mock_pdl_search.data_updated = MagicMock()
        mocker.patch("src.gui.widgets.automazioni_widget.RicercaPDLPanel", return_value=mock_pdl_search)
