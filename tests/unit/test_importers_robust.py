...
class TestImportersRobust:
    ...
    def mock_giornaliera_df(self):
        ...
        data = {
            ...
            "TCL": ["T1", "T2", ""],
            "ODC": ["540012345", "", ""], # ODC valido (formato 5400...) per evitare cancellazione
            "N° PDL": ["123", "456", ""],
            "INIZIO": ["08:00", "09:00", ""],
            "FINE": ["17:00", "18:00", ""],
            "ORE": [8, 8, 16],
    ...
    def test_process_single_giornaliera_success(self, mock_giornaliera_df, tmp_path):
        ...
        with patch("src.core.importers.giornaliere.GiornaliereImporter._read_giornaliera_sheet", return_value=mock_giornaliera_df):
    ...
    def mock_scarico_wb(self):
        ...
        row_valid = [None, "2024-01-01", "P1", "P2", "ODC1", "10", "8", "17", "8", "Desc", "S", "C"]
        ...
        row_invalid = [None, "2024-01-02", "P1", "", "", "", "8", "17", "8", "Desc", "S", "C"]
