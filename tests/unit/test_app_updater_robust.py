...
class TestAppUpdaterRobust:
    ...
    def test_has_pending_update_status(self, mock_pending):  # noqa: ANN001
    ...
    def test_show_install_prompt_delegation(self, mock_prompt):  # noqa: ANN001
        app_updater.show_install_prompt()
        mock_prompt.assert_called_once()

    @patch("src.core.updater.engine.get_local_setup_path")
    def test_get_local_setup_path_delegation(self, mock_path):  # noqa: ANN001
