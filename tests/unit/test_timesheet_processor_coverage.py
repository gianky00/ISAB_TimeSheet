...
class TestTimesheetProcessorCoverage:
    ...
    def test_process_file_no_sheet(self, tmp_path):  # noqa: ANN001
    ...
    def test_process_file_with_pos(self, tmp_path, sample_df):  # noqa: ANN001
    ...
    def test_process_file_exception(self, tmp_path):  # noqa: ANN001
