...
class TestScaricoOrePanelDeep:
    ...
    def test_update_selection_totals(self, panel):  # noqa: ANN001
    ...
    def test_header_filter_changed_logic(self, panel, mocker):  # noqa: ANN001
    ...
    def test_worker_progress_format(self, panel):  # noqa: ANN001
    ...
    def test_update_finished_ui_restore(self, panel, mocker):  # noqa: ANN001
    ...
    def test_set_search_query_flow(self, panel, mocker):  # noqa: ANN001
