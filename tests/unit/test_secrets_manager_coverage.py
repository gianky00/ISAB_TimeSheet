...
class TestSecretsManager:
    ...
    def test_get_license_key_priority_file(self, mock_env, tmp_path):  # noqa: ANN001
    ...
    def test_get_license_key_priority_keyring(self, mock_env, mock_keyring):  # noqa: ANN001
    ...
    def test_get_license_key_fallback(self, mock_env, mock_keyring):  # noqa: ANN001
    ...
    def test_get_github_token_stored(self, mock_keyring):  # noqa: ANN001
    ...
    def test_get_github_token_reconstruction(self, mock_keyring):  # noqa: ANN001
    ...
    def test_is_available_true(self, mock_keyring):  # noqa: ANN001
        assert SecretsManager.is_available() is True

    def test_is_available_false(self, mock_keyring):  # noqa: ANN001
