...
class TestDateUtils:
    ...
    def test_parse_datetime_flexible(self):
        dt = parse_datetime_flexible("2023-05-23 10:00:00")
        assert dt.year == 2023
        assert dt.hour == 10
    ...
    def test_format_date_it(self):
        ...
        dt = datetime(2023, 5, 23, 10, 0, 0, tzinfo=UTC)
        assert format_date_it(dt, include_time=True) == "23/05/2023 10:00:00"
    ...
    def test_get_date_range(self):
        ...
        start, res_end = get_date_range(10, from_date=end)
        assert res_end == end
        assert start == date(2023, 5, 13)

    def test_format_datetime_for_filename(self):
        dt = datetime(2023, 5, 23, 15, 30, 0, tzinfo=UTC)
        assert format_datetime_for_filename(dt) == "23-05-2023_15-30"
    ...
    def test_get_month_name_it(self):
        ...
        assert get_month_name_it(12) == "Dic"
