...
from src.infrastructure.utils.document_generator import generate_pdf_from_html


class TestDocumentGenerator:
    @patch("src.infrastructure.utils.document_generator.QPrinter")
    @patch("src.infrastructure.utils.document_generator.QTextDocument")
