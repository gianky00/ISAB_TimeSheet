...
class TestResourceManager:
    ...
    def setup_test(self, tmp_path, mocker):
        ...
        mocker.patch("src.utils.resource_manager.ResourceManager.ICONS_DIR", tmp_path / "assets" / "icons")
        mocker.patch("src.utils.resource_manager.ResourceManager.STYLES_DIR", tmp_path / "assets" / "styles")
        mocker.patch("src.utils.resource_manager.ResourceManager.TEMP_DIR", tmp_path / "temp")
        mocker.patch("src.utils.resource_manager.ResourceManager.DATA_DIR", tmp_path / "config" / "data")
        mocker.patch("src.utils.resource_manager.ResourceManager.LOGS_DIR", tmp_path / "config" / "logs")
        yield
