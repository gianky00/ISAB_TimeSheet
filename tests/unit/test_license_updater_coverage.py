...
class TestLicenseUpdater:
    ...
    def test_emergency_grace_activation(self, mock_paths):
        ...
        with (
            patch(
                "src.core.license_updater.time_manager.get_trusted_time", return_value=(datetime.now(), True)
            ),
            patch(
                "src.core.license_updater.SecretsManager.get_grace_period_key",
                return_value=b"6h4_H9_z8z8H9Z9H9z8z8H9Z9H9z8z8H9Z9H9z8z8H9=",
            ),
