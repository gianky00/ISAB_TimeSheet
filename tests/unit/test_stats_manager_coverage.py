...
class TestStatsManager:
    ...
    def test_increment_usage(self, manager):  # noqa: ANN001
        ...
        manager.increment_usage("bot_a")
        assert stats["bot_a"]["runs"] == 2  # noqa: PLR2004

    def test_increment_error(self, manager):  # noqa: ANN001
    ...
    def test_migration_from_old_file(self, tmp_path, mocker):  # noqa: ANN001
        # Setup old file
    ...
    def test_persistence_via_config(self, manager):  # noqa: ANN001
