...
def mock_db(tmp_path):
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        conn.execute("INSERT INTO contabilita VALUES ('123/2025', 'Manutenzione Valvole', '5400123456', 2025)")
        ...
        conn.execute("INSERT INTO giornaliere VALUES ('2025-01-01', 'Mario Rossi', 'Lavoro su ponteggi', 2025)")
        
        # Scarico Ore
        conn.execute("CREATE TABLE scarico_ore (data TEXT, pers1 TEXT, pers2 TEXT, descrizione TEXT, commessa TEXT)")
        conn.execute("INSERT INTO scarico_ore VALUES ('2025-01-02', 'Luigi Verdi', '', 'Cablaggio quadri', 'C123')")
