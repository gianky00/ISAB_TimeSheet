...
Il test dovrebbe essere riattivato solo dopo un refactoring dei widget o un aggiornamento significativo delle librerie sottostanti (`PySide6`, `pytest-qt`) che risolva il problema di fondo.
