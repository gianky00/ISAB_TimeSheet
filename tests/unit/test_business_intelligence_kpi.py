...
class TestBusinessIntelligenceKPI:
    ...
    def mock_queries(self, mocker):
        ...
        return mocker.patch("src.application.services.contabilita.stats_service.ContabilitaQueries")
    ...
    def test_get_year_stats_calculation(self, mock_queries):
        ...
        mock_data = [
            ...
            (
                ...
                "note",
                "file",
            ),  # n_prev contiene 'totale', ignorato
        ]
