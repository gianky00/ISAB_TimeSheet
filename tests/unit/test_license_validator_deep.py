...
class TestLicenseValidatorDeep:
    ...
    def test_get_license_info_decryption(self, mock_exists, mock_paths, mock_get_key):
        mock_paths.return_value = {"config": "fake.dat"}
    ...
    @patch("builtins.open", MagicMock())
    def test_get_hardware_id_linux_machine_id(self, mock_exists, mock_platform):
