...
class TestOdaArchitecture:
    ...
    def test_repository_get_all(self, mock_db_manager):
        ...
        mock_row = {
            "org_acq": "ORG1", "data_oda": "2024-05-13", "oda": "12345",
            "pos_oda": "10", "stato": "APERTO", "cat_contab": "CAT1",
            "descrizione": "DESC", "qta": 1.0, "uom": "PZ", "data_consegna": "2024-06-13",
            "valore_netto_pos": 100.0, "valore_residuo": 50.0, "valore_netto_oda": 1000.0,
            "divisione": "DIV1", "destinatario": "DEST1", "nome_destinatario": "NAME1",
            "codice_fornitore": "FORN1", "descrizione_fornitore": "FORN_DESC",
            "emittente_fattura": "EMI1", "desc_emittente_fattura": "EMI_DESC",
            "contract_card": "CC1", "contratto": "CON1", "posizione_contratto": "1",
            "gruppo_acquisti": "GRP1", "indicatore_rilascio": "X", "stato_rilascio": "OK",
            "attivita": "ACT1", "num_riga": "1", "quantita": 1.0, "unita_mis": "PZ",
            "prezzo_lordo": 100.0, "testo_breve": "SHORT", "id": 1
        }
    ...
    def test_controller_grouping(self, mock_db_manager):
        with patch("src.core.database.repositories.oda_repository.OdaRepository.get_all") as mock_get_all:
            record = OdaRecord(
                org_acq="ORG1", data_oda="2024-05-13", oda="12345",
                pos_oda="10", stato="APERTO", cat_contab="CAT1",
                descrizione="DESC", qta=1.0, uom="PZ", data_consegna="2024-06-13",
