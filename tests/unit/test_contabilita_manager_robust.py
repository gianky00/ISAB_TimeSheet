...
class TestContabilitaManagerRobust:
    ...
    def test_import_data_from_excel_success(self, mock_sync, mock_importer):
        ...
        success, msg, added, removed = ContabilitaManager.import_data_from_excel("file.xlsx")
    ...
    def test_import_giornaliere_flow(self, mock_db_mgr, mock_sync, mock_importer, mock_db_path, tmp_path):
        ...
        mock_importer.import_giornaliere.return_value = (True, "OK", [("new_row",)], [2024])
        ...
        success, msg, added, removed = ContabilitaManager.import_giornaliere(str(root_path))
    ...
    def test_import_scarico_ore(self, mock_sync, mock_importer):
        ...
        success, msg, added, removed = ContabilitaManager.import_scarico_ore("file.xlsx")
