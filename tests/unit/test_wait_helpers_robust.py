...
class TestWaitHelpersRobust:
    ...
    def test_safe_click_success(self):
        ...
        with patch("src.bots.base.wait_helpers.wait_for_element_clickable", return_value=mock_elem):
    ...
    def test_execute_with_wait(self):
        ...
        with patch("src.bots.base.wait_helpers.wait_for_overlay_to_disappear", return_value=True):
