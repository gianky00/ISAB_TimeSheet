...
class TestTelegramUIBridgeRobust:
    ...
    def test_handle_intent_add_pdl(self, bridge):  # noqa: ANN001
    ...
    def test_dispatch_data_bp(self, bridge):  # noqa: ANN001
    ...
    def test_handle_status_delegation(self, bridge):  # noqa: ANN001
