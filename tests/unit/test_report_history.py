...
class TestReportHistory:
    ...
    def test_ensure_file_creates_directory(self, mock_history_file):
        ReportHistory._ensure_file()
        assert mock_history_file.exists()

    def test_save_report(self, mock_history_file):
        ...
        assert data["last_report"]["expired_count"] == 2
        assert "1" in data["last_report"]["warning_ids"]

    def test_get_last_report(self, mock_history_file):
    ...
    def test_calculate_trend(self, mock_history_file):
        # Save initial report
        ...
        assert trend["warning_diff"] == 2  # 3 - 1
        assert trend["expired_diff"] == 1  # 2 - 1

    def test_calculate_trend_no_previous(self, mock_history_file):
        trend = ReportHistory.calculate_trend(current_warning=5, current_expired=2)
        assert trend is None

    def test_get_history(self, mock_history_file):
    ...
    def test_history_max_entries(self, mock_history_file):
    ...
    def test_load_data_handles_malformed_json(self, mock_history_file):
