...
class TestSettingsPanelCoverage:
    @pytest.fixture
    def mock_config(self, mocker):  # noqa: ANN001
    ...
    @pytest.fixture
    def mock_secrets(self, mocker):  # noqa: ANN001
        sm = mocker.patch("src.core.secrets_manager.SecretsManager")
        sm.get_gemini_api_key.return_value = "dummy_key"
        return sm

    @pytest.fixture
    def panel(self, qapp, qtbot, mock_config, mock_secrets, mocker):  # noqa: ANN001
    ...
    def test_init_ui(self, panel):  # noqa: ANN001
    ...
    def test_load_config_to_ui(self, panel):  # noqa: ANN001
    ...
    def test_autosave_behavior(self, panel, mock_config):  # noqa: ANN001
    ...
    def test_account_dialog_visibility_toggle(self, qtbot):  # noqa: ANN001
