...
def test_import_excel_logic(panel):
    ...
    with (
        patch("PyQt6.QtWidgets.QFileDialog.getOpenFileName", return_value=("test.xlsx", "Excel")),
        ...
        mock_toast.return_value.show.assert_called_with("Dati importati correttamente nel database.", "success")
