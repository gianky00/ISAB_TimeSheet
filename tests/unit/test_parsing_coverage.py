...
class TestParsing:
    ...
    def test_parse_currency_italian(self):
        ...
        assert parse_currency("50,83 Euro") == 50.83  # noqa: PLR2004

    def test_parse_currency_international(self):
        assert parse_currency("1,234.56") == 1234.56  # noqa: PLR2004
        assert parse_currency("508.83") == 508.83  # noqa: PLR2004
    ...
    def test_parse_currency_multiple_dots(self):
        ...
        assert parse_currency("1.000.000") == 1000000.0  # noqa: PLR2004
