...
class TestParsing:
    def test_parse_currency_basic(self):
        ...
        assert parse_currency(100.5) == 100.5  # noqa: PLR2004
    ...
    def test_parse_currency_it_format(self):
        ...
        assert parse_currency("12,34") == 12.34  # noqa: PLR2004
        assert parse_currency("€ 1.500") == 1500.0  # noqa: PLR2004

    def test_parse_currency_us_format(self):
        """Verifica il parsing del formato internazionale/US."""
        assert parse_currency("1,234.56") == 1234.56  # noqa: PLR2004
        assert parse_currency("1,234") == 1.234  # Virgola trattata come decimale se sola  # noqa: PLR2004
        assert parse_currency("12.34") == 12.34  # noqa: PLR2004
    ...
    def test_parse_currency_negative(self):
        ...
        assert parse_currency("-100") == -100.0  # noqa: PLR2004
        assert parse_currency("100 -") == -100.0  # noqa: PLR2004
        assert parse_currency("- 50,20") == -50.20  # noqa: PLR2004

    def test_parse_currency_dirty_strings(self):
        """Verifica la pulizia di stringhe con testo extra o caratteri non stampabili."""
        assert parse_currency("Circa 100 Euro") == 100.0  # noqa: PLR2004
        assert parse_currency("100\u200b.50") == 100.50  # Zero-width space  # noqa: PLR2004
        assert parse_currency("Prezzo: 1.200,00 €") == 1200.0  # noqa: PLR2004
