...
def test_pdl_controller_returns_dtos_with_mocked_db(mock_db_manager):
    ...
    mock_row = (1, "PDL001", "2023-01-01", "Area1", "Unita1", "Ditta", "Desc", "Tipo", 
                "Aperto", "App", "Rich", "DataR", "Emitt", "DataE", "Apr", "DataA", 
                "Alta", "Contr", "Ord", "Sito", "Importato")
    ...
    assert mock_db_manager.execute_query.call_count == 1, "La seconda chiamata deve usare la cache interna, non il DB"
