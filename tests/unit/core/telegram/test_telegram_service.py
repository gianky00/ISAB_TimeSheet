...
class TestTelegramService:
    @pytest.fixture
    def service(self):
        with patch("src.application.services.config_manager.load_config") as mock_config:
    ...
    @patch("src.api.telegram.service.Application.builder")
    ...
    @patch("src.api.telegram.service.get_asset_path", return_value="icon.png")
