...
def test_pdl_dto_immutability_and_slots():
    ...
    row = (1, "PDL001", "2023-01-01", "Area1", "Unita1", "Ditta", "Desc", "Tipo", 
    ...
    assert not hasattr(dto, "__dict__"), "Il DTO non deve avere __dict__ se slots=True è configurato correttamente"
