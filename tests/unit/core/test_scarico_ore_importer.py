...
class TestScaricoOreImporter:
    def test_validate_scarico_row_logic(self):
        ...
        assert ProcessScaricoOreRowsStep._validate_scarico_row(valid_vals) is True

        # Mancano ODC e POS
        invalid_vals = ["2024-01-01", "Mario", "", "", "", "08:00", "17:00", "8.0", "Lavoro", "NO", "C1"]
        assert ProcessScaricoOreRowsStep._validate_scarico_row(invalid_vals) is False
        ...
        assert ProcessScaricoOreRowsStep._validate_scarico_row(invalid_vals_no_pers) is False
    ...
    def test_extract_row_values_formatting(self):
        ...
        vals = step._extract_row_values(row)
