...
from src.application.services.logging.decorators import log_entry_exit, measure_time


class TestDecorators:
    @patch("src.application.services.logging.decorators.get_logger")
    @patch("src.application.services.logging.decorators.get_tracker")
    ...
    @patch("src.application.services.logging.decorators.time.perf_counter")
    @patch("src.application.services.logging.decorators.get_logger")
    @patch("src.application.services.logging.decorators.get_tracker")
