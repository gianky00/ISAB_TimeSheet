...
class TestBaseBot:
    ...
    def bot(self):
        ...
        with patch('src.bots.base.base_bot.ChromeDriverManager'), \
    ...
    def mock_delays(self):
        ...
        with patch('src.bots.base.base_bot.time.sleep'), \
             patch('src.bots.base.base_bot.WebDriverWait'): # Mock WebDriverWait costruttore
            yield
