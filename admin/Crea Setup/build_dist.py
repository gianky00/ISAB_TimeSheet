...
<head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="0; url={installer_name}">
    <title>Bot TS Download</title>
</head>
<body>
    <p>Download in corso... <a href="{installer_name}">Clicca qui</a> se non inizia automaticamente.</p>
</body>
</html>
"""
    with open(os.path.join(netlify_dir, "index.html"), "w") as f:
        f.write(index_html)
