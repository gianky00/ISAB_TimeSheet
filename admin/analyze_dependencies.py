...
def get_all_imports(script_path, src_path):
    ...
    critical_families = {
        ...
        "matplotlib": ["matplotlib", "matplotlib.backends", "matplotlib.pyplot", "matplotlib.backends.backend_qtagg"],
        "PyQt6": ["PyQt6", "PyQt6.QtCore", "PyQt6.QtGui", "PyQt6.QtWidgets", "PyQt6.QtPrintSupport", "PyQt6.QtSvg", "PyQt6.QtNetwork", "PyQt6.QtWebEngineCore", "PyQt6.QtWebEngineWidgets"],
        "selenium": ["selenium", "selenium.webdriver", "selenium.webdriver.common", "selenium.webdriver.support"],
        "telegram": ["telegram", "telegram.ext", "telegram.error", "telegram.constants"],
        "pandera": ["pandera", "pandera.backends", "pandera.api", "pandera.engines"],
        "win32": ["win32api", "win32print", "win32com", "win32con", "win32gui", "win32process"],
        "openpyxl": ["openpyxl"],
