...
class SecretItem(QFrame):
    def __init__(self, app_name, service_label, secret_key, parent=None):
        ...
        if current_val: self.input.setText(current_val)
    ...
    def _toggle(self):
        self.input.setEchoMode(QLineEdit.EchoMode.Normal if self.input.echoMode() == QLineEdit.EchoMode.Password else QLineEdit.EchoMode.Password)
