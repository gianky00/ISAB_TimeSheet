...
def _build_context(version: str) -> dict:  # type: ignore[type-arg]
    ...
    return {
        ...
        "development_commands": {
            "run": "uv run syncrojob",
            "lint": "uv run ruff check --fix",
            "format": "uv run ruff format",
            "type_check": "uv run mypy --strict src/",
            "docstring_check": "uv run interrogate src/",
            "complexity_check": "uv run xenon src/ --max-absolute B --max-modules B --max-average A",
            "cohesion_check": "uv run python devtools/maintenance/check_cohesion.py",
            "quality_check_all": "uv run python devtools/maintenance/quality_check.py",
            "pre_commit": "uv run pre-commit run --all-files",
            "generate_schemas": "uv run python devtools/cli/generate_schemas.py",
            "generate_ai_context": "uv run python devtools/cli/generate_ai_context.py",
            "generate_ci_context": "uv run python devtools/cli/generate_ci_context.py",
            "generate_architecture": "uv run python devtools/cli/generate_architecture.py",
