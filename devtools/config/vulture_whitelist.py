...
get_name  # unused method (src/infrastructure/bots/...)
get_description  # unused method (src/infrastructure/bots/...)
get_columns  # unused method (src/infrastructure/bots/...)
...
add_account  # unused function (src/application/services/config_manager.py)
remove_account  # unused function (src/application/services/config_manager.py)
set_default_account  # unused function (src/application/services/config_manager.py)
run_retention_policy  # unused method (src/application/services/audit_manager.py)
validate_codice_fiscale  # unused method (src/infrastructure/utils/validators.py)
sanitize_sql_string  # unused method (src/infrastructure/utils/validators.py)
get_fornitori  # unused function (src/application/services/config_manager.py)
get_openai_key  # unused method (src/application/services/secrets_manager.py)
derive_key  # unused method (src/application/services/secrets_manager.py)

# Test Helpers & Debug
_reset_configuration_for_testing  # unused function (src/application/services/config_manager.py)

# Data Structures & Constants
LOGGING_IN  # unused variable (src/application/services/constants.py)
USER_AGENT  # unused variable (src/application/services/constants.py)
POPUP_ATTENTION_HEADER  # unused variable (src/infrastructure/bots/...)
POPUP_YES_BUTTON  # unused variable (src/infrastructure/bots/...)
BT_SI_SESSIONE_ATTIVA  # unused variable (src/infrastructure/bots/...)
GRID_CHECKER_ROWS  # unused variable (src/infrastructure/bots/...)
ROW_CHECKBOX  # unused variable (src/infrastructure/bots/...)
GRID_ROWS  # unused variable (src/infrastructure/bots/...)
HAS_OPENPYXL  # unused variable (src/application/services/excel_importer.py)
GRACE  # unused variable (src/application/services/license_validator.py)
...
dwFlags  # unused attribute (src/application/services/license_validator.py)
...
logout  # unused method (src/infrastructure/bots/.../dettagli_oda_page.py)
verifica_disponibilita_materiali  # unused method (src/infrastructure/bots/.../prenota_bp_page.py)
prenota_nuovo_bp  # unused method (src/infrastructure/bots/.../prenota_bp_page.py)
_espandi_parte_seconda  # unused method (src/infrastructure/bots/.../bot.py)
setup_app_style  # unused method (src/application/services/app_initializer.py)
increment_error  # unused method (src/application/services/stats_manager.py)
execute_query  # unused method (src/application/services/database.py)
...
check_grace_period  # unused function (src/application/services/license_updater.py)
is_running_from_source  # unused function (src/application/services/license_updater.py)
is_license_folder_empty  # unused function (src/application/services/license_updater.py)
verify_license  # unused function (src/application/services/license_validator.py)
get_license_expiry  # unused function (src/application/services/license_validator.py)
get_license_client  # unused function (src/application/services/license_validator.py)
import_to_db_static  # unused method (src/infrastructure/bots/portale_fornitori/timbrature/bot.py)
validate_date_italian  # unused method (src/infrastructure/utils/validators.py)
get_icon  # unused method (src/infrastructure/utils/resource_manager.py)
get_style  # unused method (src/infrastructure/utils/resource_manager.py)
get_temp_path  # unused method (src/infrastructure/utils/resource_manager.py)
total_prev  # unused variable (src/application/services/contabilita_stats.py)
count_total  # unused variable (src/application/services/contabilita_stats.py)
status_counts  # unused variable (src/application/services/contabilita_stats.py)
top_commesse  # unused variable (src/application/services/contabilita_stats.py)
...
ProgrammingSyncManager  # unused class (src/application/services/importers/pdl_sync_manager.py)
...
alert_appears_with_text  # unused class (src/infrastructure/bots/base/wait_helpers.py)
SamplingFilter  # unused class (src/application/services/logging/filters.py)
